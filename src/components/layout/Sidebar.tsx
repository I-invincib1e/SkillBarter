...
export function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 bottom-0 z-40 hidden md:flex flex-col w-[220px] lg:w-[260px] glass-sidebar">
        ...
        {mainNav.map((item) => {
          ...
          return (
            <Link
              ...
              to={item.path}
              className={`
                flex items-center gap-3 px-3 py-2.5 rounded-lg font-mono text-xs font-medium transition-all duration-150
                ${isActive
        ...
        {bottomNav.map((item) => {
          ...
          return (
            <Link
              ...
              to={item.path}
              className={`
                flex items-center gap-3 px-3 py-2 rounded-lg font-mono text-[11px] font-medium transition-all duration-150
                ${isActive
      ...
      <div className="px-3 py-3 border-t border-gray-200/60 dark:border-white/10 flex items-center gap-1">
        <button
          onClick={toggleTheme}
          className="flex-1 flex items-center justify-center gap-2 px-2 py-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100/80 dark:hover:bg-white/5 transition-colors font-mono text-[11px]"
        >
        ...
        <button
          onClick={signOut}
          className="flex-1 flex items-center justify-center gap-2 px-2 py-2 rounded-lg text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors font-mono text-[11px]"
        >
